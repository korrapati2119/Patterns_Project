package com.korrapatiClasses.DMS.Controllers;
...
import com.korrapatiClasses.DMS.repository.DogRepository;
import com.korrapatiClasses.DMS.repository.TrainerRepository;
...
//		return home();
	...
	public ModelAndView searchByName(@RequestParam String name) {
		List<Dog> dogsFound = dogRepo.findByName(name);
		mv.addObject("dogs", dogsFound);
		mv.setViewName("searchResults");
		return mv;
	}
